...
export const updatePhaseState = (projectId, phaseNumber, data) => api.put(`/analysis/phase-state/${projectId}/${phaseNumber}`, data).then(r => r.data)
export const sendPhaseChat = (data) => api.post('/analysis/chat', data).then(r => r.data)
export const validatePhase = (projectId, phaseNumber) => api.get(`/analysis/validate-phase/${projectId}/${phaseNumber}`).then(r => r.data)
export const advancePhase = (projectId) => api.post(`/analysis/advance-phase/${projectId}`).then(r => r.data)
export const previousPhase = (projectId) => api.post(`/analysis/previous-phase/${projectId}`).then(r => r.data)
export const resetProject = (projectId) => api.post(`/analysis/reset-project/${projectId}`).then(r => r.data)
